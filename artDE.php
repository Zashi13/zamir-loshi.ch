...
<header>
    ...
    <div class="language"><a href="artDE.php"><p class="unselected">DE</p></a><a href="art.php"><p class="selected">EN</p></a></div>
	  ...
	  <h1 class="center">Mehr als nur <span class="mark">Erinnerungen.</span><br>
			  Sondern <span class="mark">Kunst!</span> </h1>
...
<div class="menu white" id="menupoints">
	...
	<!-- <div class="background" id="contact">
		...
		<h2 class="contactadjustement">Sag mir was <span class="orange">du brauchst</span> und <br>
			ich sende dir <span class="orange">eine Offerte</span>.*</h2>
		
					<form method="post" action="sendmail.php">
					<div class="form">	
				<select id="contactreason" name="reason" required>
					<option value="">Thema</option>
						<option value="EventPhoto">Pärchen Portraits</option>
					<option value="Kart">Verlobung</option>
